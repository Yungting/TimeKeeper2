package com.example.user.myapplication.guide;
...
public class guide_page extends Activity implements View.OnClickListener{

    private ViewPager vp;
    private guide_adpter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 初始化adapter
        adapter = new guide_adpter(views);
        vp.setAdapter(adapter);
        //noinspection deprecation
        vp.setOnPageChangeListener(new guide_page.PageChangeListener());
